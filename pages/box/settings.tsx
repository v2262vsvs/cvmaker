...
const Settings = () => {
    ...
    return (
        <>
            ...
            <div className={'md:fixed z-20'}>
                <div
                    className=' flex flex-col  mx-auto lg:mt-16 lg:pl-12 pl-4  lg:left-28 left-6 mt-6 max-[758px]:h-[1000px] md:mb-44'>
                    ...
                    {/*<div className="shadow-xl z-30 fixed bottom-0 max-sm:hidden left-0">*/}
                    {/*    <Footer />*/}
                    {/*</div>*/}
                    {/*<div className="shadow-xl z-30  min-:hidden ">*/}
                    {/*    <Footer />*/}
                    {/*</div>*/}
            ...
            <svg
                className={'fixed bottom-0 right-0 pl-10 max-[768px]:hidden z-10'}
            ...
            <div
                className="shadow-xl md:fixed md:bottom-0 z-0">
                <Footer />
            </div>
