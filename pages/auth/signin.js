...
export default function SignIn({ providers }) {
    ...
    return (
        <>
            ...
            <div className='flex flex-col   h-screen justify-center items-center scroll-none'>
            ...
            <div className="text-violet-700 text-xs font-light xl:text-md lg:text-sm mb-5">Only registered users can download resume</div>
                ...
                <div className="border-dashed border-2 border-indigo-600  rounded-xl  w-92 lg:w-1/3 xl:w-1/3 mx-auto py-2">
