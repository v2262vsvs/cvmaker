            ...
            <div className="mr-10 ml-10 pb-10 -mt-2 space-y-4">
                ...
                <div key={index} className="  -mt-2 space-y-4">
                  ...
                  <div className="flex space-x-7">
                    <div className="space-y-2 grow">
                      <div className="text-neutral-600 text-sm">Degree</div>
                      <input
                  ...
                  <div className="">
                    <div className="space-y-2 ">
                      <div className="text-neutral-600 text-sm">School</div>
                      <input
                  ...
                  {togleRange && (
                    <div className="" >
                      <Calendar onChange={item => handleChangeEducationDate(item,index,'startdate')} date={new Date(education?.startDate)} />
                    </div>
                  )}
                  {togleRange2 && (
                    <div className="ml-96 pl-10" >
                      <Calendar onChange={item => handleChangeEducationDate(item,index,'enddate')} date={new Date(education?.endDate)} />
                    </div>
                  )}
                  <div className="flex justify-between">
                    <div className="">
                      <MyModal advice={`
                       1 .Indicate only those courses that you actually attended.
                       ...
                       4 .Include a description of your course to explain to potential employers exactly what it included. 5 .Want to organize your points in chronological order? Click the gear icon in the upper right corner of the section and select Sort chronologically. `} />
                    </div>
                    ...
                    <div className="flex space-x-3">
                      ...
                      >
                        <div onClick={() => handleRemoveEducation(index)} className="flex sapce-x-2 ">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div onClick={()=>setVisibleEducation(index)}>
                        ...
                        <div className="flex justify-between ">
                            <div className="mt-auto mb-auto text-neutral-400 text-md">
                                ...
                                <div className="text-xs">{months[new Date(education.startDate).getMonth()]} {new Date(education.startDate).getFullYear()}–{months[new Date(education.endDate).getMonth()]} {new Date(education.endDate).getFullYear()}</div>
                            </div>
                            <div className=" flex space-x-3 mt-auto mb-auto  text-neutral-600">
                                <div className="cursor-pointer" onClick={()=>handleRemoveEducation(index)}>
              ...
              <div>
                ...
                >
                  ...
                  <div className="mt-auto mb-auto">Add another Aducation</div>
                </button>
              </div>
            </div>
          )}
