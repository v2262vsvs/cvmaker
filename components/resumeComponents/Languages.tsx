        ...
        <div className="bg-white max-w-[850px] shadow-xl rounded-md  mr-auto ml-auto ">
          ...
          >
            <div className="flex py-8 px-10 space-x-2">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 font-medium bg-white text-neutral-700" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <div className="flex space-x-7">
                    ...
                    <div className="space-y-2 grow">
                      ...
                      <select value={languages.level}
                        ...
                        } name="level" id="cars" className="ring-2 ring-gray-200 my-auto text-lg px-4 py-3 text-neutral-600   rounded-sm w-full outline-none">
                        <option className='' value="choose">to choose</option>
                        <option className="" value="expert">Native Language</option>
                        <option value="experienced">Hight level of spoken and written language</option>
                        <option value="skillful">Very good knowledge</option>
                        <option value="beginner">Knowledge at a good working level</option>
                        <option value="newcomer">Working knowledge</option>
                        <option value="newcomer">A1</option>
                        <option value="newcomer">A2</option>
                        <option value="newcomer">B1</option>
                        <option value="newcomer">B2</option>
                        <option value="newcomer">C1</option>
                        <option value="newcomer">C2</option>
                      </select>
                    </div>
                  </div>
...
2 .Specify as many languages ​​as possible, but only those that you speak, read and really understand. " />
                    ...
                    <div className="flex space-x-3">
                      ...
                      >
                        <div onClick={() => handleRemoveLanguages(index)} className="flex sapce-x-2 ">
                          <svg
                    ...
                    <div onClick={()=>setVisibleLanguages(index)}>
                        ...
                        <div className="flex justify-between ">
                            <div className="mt-auto mb-auto text-neutral-400 text-md">
                                ...
                                <div className="text-xs">{languages.language}</div>
                            </div>
                            <div className=" flex space-x-3 mt-auto mb-auto  text-neutral-600">
                                <div className="cursor-pointer" onClick={()=>handleRemoveLanguages(index)}>
