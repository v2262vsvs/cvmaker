                ...
                className={classNames(
                    type === 'downloadSample' ? ''
                        : type === 'modalSample' ? 'sampleScale50'
                            :  choose === 2 ? 'ring-2 ring-offset-1 ring-violet-700 ring-rounded-lg ring-offset-violet-700  sampleScale50'
                                : 'sampleScale50'
                )}
                // className={`${
                //     scale
            ...
            >
                <div className="   ">
                    <div className="flex justify-between">
                        ...
                        <div
                            className="bg-violet-700 text-xl text-white font-semibold pt-1 text-center w-10 h-10 mr-5">
                            CV2
                        </div>
                    </div>
                    <div className="flex px-5 pt-3 space-x-3">
                    ...
                    <div
                        className=" border-t-0.1 max-w-[555px] mt-3 mb-10 ml-auto mr-auto border border-gray-200"></div>
