        ...
        <div className="bg-white max-w-[850px] shadow-xl rounded-md  mr-auto ml-auto ">
          ...
          >
            <div className="flex py-8 px-10 space-x-2">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 font-medium text-neutral-700" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div key={index} className="  -mt-2 space-y-4">
                  ...
                  <div className="">
                    <div className="space-y-2 ">
                      <div className="text-neutral-600 text-sm">Employer</div>
                      <input
                  ...
                  {togleRange && (
                    <div className="" >
                      <Calendar onChange={item => handleChangeExperienceDate(item,index,'startdate')} date={new Date(experience?.startDate)} />
                    </div>
                  )}
                  {togleRange2 && (
                    <div className="ml-96 pl-10" >
                      <Calendar onChange={item => handleChangeExperienceDate(item,index,'enddate')} date={new Date(experience?.endDate)} />
                    </div>
                  )}
                  <div className="flex justify-between">
                    <div className="">
                      <MyModal advice="1 .Use the correct job title for the job you are applying for. For example, Salesperson should be replaced with Customer Relations Manager.
...
5 .Want to organize your points in chronological order? Click the gear icon in the upper right corner of the section and select Sort chronologically." />
                    ...
                    <div className="flex space-x-3">
                      ...
                      >
                        <div onClick={() => handleRemoveExperience(index)} className="flex sapce-x-2 ">
                          <svg
                    ...
                    <div onClick={()=>setVisibleExperience(index)}>
                        ...
                        <div className="flex justify-between ">
                            <div className="mt-auto mb-auto text-neutral-400 text-md">
                                ...
                                <div className="text-xs">{months[new Date(experience.startDate).getMonth()]} {new Date(experience.startDate).getFullYear()}–{months[new Date(experience.endDate).getMonth()]} {new Date(experience.endDate).getFullYear()}</div>
                            </div>
                            <div className=" flex space-x-3 mt-auto mb-auto  text-neutral-600">
                                <div className="cursor-pointer" onClick={()=>handleRemoveExperience(index)}>
