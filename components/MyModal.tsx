...
export default function MyModal({advice}:Props) {
      ...
      <div className="  flex items-center justify-center">
        ...
        >
            <div className='flex sapce-x-2'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 hover:text-yellow-400 text-neutral-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
