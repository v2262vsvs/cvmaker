    ...
    return (
        <div className=''>
            <div className=" pb-5 pt-2 max-w-2xl max-h-96 container mx-auto rounded-b-xl">
                <div
                    className="ml-auto mr-auto mt-12 items-center text-center max-w-[500px] lg:max-w-[650px] max-[485px]:w-64 space-y-4">
                    ...
                    <Link href="/box/personal">
                        <button
                            className="bg-violet-700 text-white text-lg xl:text-xl font-semibold rounded-md py-2 px-4 xl:py-4 xl:px-7 hover:shadow-lg animation-button">
                            {t('Create My Resume')}
                        </button>
                    </Link>
                </div>
            ...
            <div className='container mx-auto mt-16 '>
                <Image src='/Photo.svg' width='1528' height='412' className={'shadow-violetShadow'}/>
            </div>

            <div className='bg-white flex justify-center px-4 py-2 -mt-2'>
                <Image className='' src='/Chevrondown.svg' width='46' height='46'/>
            </div>

            <div className='bg-white container mx-auto mt-28 mb-28 rounded-xl shadow-violetShadow max-md:h-[860px] max-[485px]:h-[1000px]'
                 // style={{width: '1528px', height: '578px'}}
            >
                <div className='h-14'></div>

                <div className='flex mx-auto place-items-center text-center items-center justify-center  max-[485px]:w-56 '>
                ...
                <div className='lg:flex md:flex justify-center ml-10 mr-10 lg:space-x-16 md:space-x-16 mt-12 max-[485px]:space-x-0  max-[485px]:w-44'>
                    <div className='flex space-x-4 max-md:mx-auto max-[1010px]:w-80'>
                        ...
                        <div>
                            ...
                            <div className='text-gray-500 text-xs lg:text-sm max-[340px]:w-44'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores <br/>impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis <br/>ratione. </div>
                        </div>
                    </div>
                    <div className='flex space-x-4 mx-auto max-[1010px]:w-80 max-md:mt-12'>
                ...
                <div className='lg:flex md:flex justify-center ml-10 mr-10 lg:space-x-16 md:space-x-16 mt-12 max-[485px]:space-x-0 max-[485px]:w-44'>
                    ...
                    <div className='flex space-x-4  max-md:mx-auto max-[1010px]:w-80 mb-14 max-md:mt-12 '>
            ...
            <div className='bg-violet-200 flex-row '
                 style={{width: '100%'}}
            >
                ...
                <div className='bg-white mt-28   place-items-center text-center items-center flex justify-center ' style={{width: '100%', height: '268px'}}>
                        ...
                        <p className="text-gray-500 text-sm lg:text-md mb-16 max-[485px]:w-56 mx-auto">
                ...
                <Link href={'/box/personal'}>
                    <div className='ml-32 mr-10 max-[1020px]:mx-auto ' >
                        <CvCards/>
                    </div>
                </Link>
            </div>
            ...
            <div
                className={'pb-5 pt-2 max-w-2xl max-h-96 container mx-auto rounded-b-xl mb-14'}
                style={{marginTop: '2px'}}
                //className=" pb-5 pt-2 container mx-auto mb-16 " style={{marginTop: '2px'}}
            >
                <div
                    //style={{width: '850px', height: '325px'}}
                    className="ml-auto mr-auto mt-12 items-center text-center max-w-[500px] lg:max-w-[650px] max-[597px]:w-[220px] space-y-4"
                >
